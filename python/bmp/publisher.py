...
import thread
import lcm
from bmp_lcm import pressure_t

import Adafruit_GPIO.I2C as I2C


"""
LCM publisher for the BMP280
...
def bmp_run():
    ...
    if (device.readS8(BMP280_REGISTER_CHIPID) == 0x58): # check sensor id 0x58=BMP280
        ...
        while True: # loop
            ...
            msg = pressure_t()
            msg.time = time.time()*1000000.0
            msg.temperature = temp
            msg.pressure = press

            lcm_node.publish("PRESSURE", msg.encode())
            time.sleep(0.050)
...
if __name__ == "__main__":
    ...
    try:
        thread.start_new_thread( bmp_run,() )
    except:
        print "ERROR: could not start publisher thread"
